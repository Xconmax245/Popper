...
[![IIT Madras Research Agents Hack](https://img.shields.io/badge/IIT%20Madras-Research%20Agents%20Hack-0EB770)](https://github.com/popper-verify/popper)
...
```
INGEST → EXTRACT → VERIFY (parallel) → SYNTHESIZE → AUDIT → DONE
```
...
```bash
git clone https://github.com/popper-verify/popper
cd popper
npm install
```
